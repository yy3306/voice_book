...
class Musics {
    ...
    constructor() {
        ...
        this.songs = [
        	{
                id: 1,
                title: '《阴间神探》第001章 断狱神篇（新故事哦，仵作破案）',
                singer: '有声的紫襟',
                songUrl: '/book/assets/imgs/songs/voice01.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 2,
                title:'《阴间神探》第002章 百年一遇的奇才',
                singer: '有声的紫襟',
                songUrl: '/book/assets/imgs/songs/voice02.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 3,
                title: '《阴间神探》第003章 替身葬（来订阅吧）',
                singer: '有声的紫襟',
                songUrl:'/book/assets/imgs/songs/voice03.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 4,
                title: '《阴间神探》第004章 提刑官宋慈（求分享到朋友圈~）',
                singer: '有声的紫襟',
                songUrl: '/book/assets/imgs/songs/voice04.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 5,
                title:'《阴间神探》第005章 爷爷之死',
                singer: '有声的紫襟',
                songUrl: '/book/assets/imgs/songs/voice05.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 6,
                title: '《阴间神探》第006章 江北残刀',
                singer: '有声的紫襟',
                songUrl:'/book/assets/imgs/songs/voice06.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 7,
                title: '《阴间神探》第007章 十年前的诡案（订阅哦~）',
                singer: '有声的紫襟',
                songUrl: '/book/assets/imgs/songs/voice07.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 8,
                title:'《阴间神探》第008章 正邪较量（订阅哦~）',
                singer: '有声的紫襟',
                songUrl: '/book/assets/imgs/songs/voice08.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            },
            {
                id: 9,
                title: '《阴间神探》第009章 校园自杀事件',
                singer: '有声的紫襟',
                songUrl:'/book/assets/imgs/songs/voice09.mp3',
                imageUrl: '/book/assets/imgs/yinjianshentan.jpg'
            }
...
/*    	var chapters='${chapters}';
    	...
    	for(var i=0;i<chapters.length;i++){
    	    ...
    	    var chaptersId=chapters[i].id;
    	   var audioId=chapters[i].audioId;
    	   
    	  	console.log(name+chaptersId+audioId);
    	}
